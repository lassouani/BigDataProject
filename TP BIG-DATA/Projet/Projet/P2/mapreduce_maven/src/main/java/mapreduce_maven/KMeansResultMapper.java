...
public class KMeansResultMapper extends Mapper<LongWritable, Text, NullWritable, Text> {
	...
	public void setup(Context context) throws IOException {
		...
		FileN = context.getConfiguration().getInt("FileN", 0);
		FileK = context.getConfiguration().getInt("FileK", 0);
	...
	public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
		...
		mos.write("file"+cPlusProche,NullWritable.get(), new Text(data), (FileK*K+cPlusProche)+"/result");
